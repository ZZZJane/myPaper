...
if __name__ == '__main__':
    ...
    parser_calculate_pesq_noise = subparsers.add_parser('calculate_pesq_noise')
    parser_calculate_pesq_noise.add_argument('--workspace', type=str, required=True)
    parser_calculate_pesq_noise.add_argument('--speech_dir', type=str, required=True)
    parser_calculate_pesq_noise.add_argument('--te_snr', type=float, required=True)
    ...
    if args.mode == 'plot_training_stat':
        ...
        calculate_pesq(args)
    elif args.mode == 'calculate_pesq_noise':
        calculate_pesq_noise(args)
