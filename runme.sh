...
#python prepare_data.py create_mixture_csv --workspace=$VOICE_LIB --speech_dir=$TR_SPEECH_DIR --noise_dir=$TR_NOISE_DIR --data_type=train --speech_size=2000 #--magnification=10
#python prepare_data.py create_mixture_csv --workspace=$VOICE_LIB --speech_dir=$TE_SPEECH_DIR --noise_dir=$TE_NOISE_DIR --data_type=test --speech_size=200
...
# Plot training stat.
TR_SNR=15
#python evaluate.py plot_training_stat --workspace=$WORKSPACE --tr_snr=$TR_SNR --bgn_iter=0 --fin_iter=3001 --interval_iter=100
